 ...
 * features carry their own anchored budgets (NFR-805, NFR-904, NFR-1001, NFR-1201, NFR-1301, NFR-1501).
 * NFR-904 is historical as of spec-10; NFR-1001 is historical as of spec-12;
 * NFR-1201 is historical as of spec-13; NFR-1301 is historical as of spec-15.
...
/**
 * App-payload size budgets (NFR-805, NFR-1501) measure over the app's own
...
test(`VC-623 (NFR-603, NFR-606): completion paints in under ${COMPLETION_PAINT_MS} ms on 500 lines, without a long task or request`, async ({
  ...
  // of spec-12; NFR-1201 is historical as of spec-13; NFR-1301 is historical
  // as of spec-15. Live size budgets are NFR-805 / NFR-1501 against their
  // own branch points.
