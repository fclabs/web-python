...
- **Budget** (NFR-405): ≤ 2 KB gzipped against commit `98ee032` (spec-01 + spec-03 + spec-05 — not `384cb70`); zero extra requests; zero new runtime assets. Measured: **1.62 KiB**. Spec-03 / spec-05 deltas stay on VC-323 / VC-513.
