...
commits VC-408 and the live app-size budgets (NFR-805 and NFR-1501) are pinned
...
`PYPLAY_BASELINE_BUILD`, and `PYPLAY_BASELINE_FOLD`. Both jobs check out with
`fetch-depth: 0`,
...
budget. NFR-606, NFR-904, NFR-1001, NFR-1201, and NFR-1301 are historical,
while NFR-805 and NFR-1501 remain live at the current spec boundary.
